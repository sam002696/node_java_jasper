...
@RestController
public class LightEngineeringQuestionsController {

    private static final Logger logger = LoggerFactory.getLogger(LightEngineeringQuestionsController.class);

    @PostMapping("/light-engineering-questions-report")
    public ResponseEntity<byte[]> generateReport(@RequestBody LightEngineeringQuestions document) {
        try {
